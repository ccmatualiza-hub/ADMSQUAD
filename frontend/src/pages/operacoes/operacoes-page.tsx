  ...
  return (
    <div>
      ...
      <div className="row g-3">
        ...
        <div className="col-12 col-md-4 col-lg-3">
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: 12, marginBottom: 10 }}>
              ...
              <div style={{ fontSize: 13, fontWeight: 700, color: 'var(--ccm-ink)', textTransform: 'uppercase', letterSpacing: '.06em' }}>
                Daily — Pendências
              </div>
            </div>
        ...
        <div className="col-12 col-md-4 col-lg-3">
          <div style={{
            background: '#F7F8FA', border: '1px dashed var(--ccm-line)', borderRadius: 6,
            padding: '20px 22px', display: 'flex', alignItems: 'center', justifyContent: 'center',
            minHeight: 120, color: 'var(--ccm-gray-medium)', fontSize: 12, letterSpacing: '.08em',
          }}>
