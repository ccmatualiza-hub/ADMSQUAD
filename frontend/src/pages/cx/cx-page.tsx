...
type SubPage = null | 'clientes' | 'monitor' | 'agendar' | 'adiantar';
  ...
  return (
    <div>
      ...
      <div className="row g-3">
        ...
        <Card title="Adiantar Atendimentos Linx" desc="Registrar atendimentos aguardando ticket de abertura Linx." color="#E74C3C" icon="bi-ticket-detailed"      onClick={() => setSubPage('adiantar')} />
        <div className="col-12 col-md-4 col-lg-3">
